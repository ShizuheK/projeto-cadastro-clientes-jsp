...
<div class="right_col" role="main">
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Bem vindo a página principal do sistema</h3>
            </div>
        </div>
        <div class="col-md-12 col-sm-6">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Lojinha dos XDs<small>Sistema de Cadastro e Análise</small></h2>
                ...
                <div class="x_content">
                    ...
                    <div class="bs-example" data-example-id="simple-jumbotron">
                        <div class="jumbotron">
                            <h1>Olá, mundo!</h1>
                            <p>Esse sistema foi desenvolvido para cominucar-se com uma database, por meio de páginas em JSP, cadastrando produtos e gerenciando entradas, listas e relatórios.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Sua Inbox<small>E-mail do Usuário</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                        </li>
                        <li class="dropdown">
