            ...
            <section class="login_content">
                <form action="./Logar" method="post">
                    ...
                    <div>
                        ...
                        <a class="btn btn-default submit" href="./principal/pagina_principal.jsp">Prosseguir</a>
                    ...
                    <div class="separator">
                        ...
                        <div>
                            <h1><i class="fa fa-bed"></i> Lojinha dos XDs</h1>
        ...
        <div id="register" class="animate form registration_form">
            <section class="login_content">
                <form>
                    ...
                    <div>
                        <a class="btn btn-default submit" href="index.jsp">Enviar</a>
                    </div>
